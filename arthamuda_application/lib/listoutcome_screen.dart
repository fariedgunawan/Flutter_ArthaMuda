...
class ListTransactionOutcomeScreen extends StatefulWidget {
  const ListTransactionOutcomeScreen({super.key});

  @override
  State<ListTransactionOutcomeScreen> createState() => _ListTransactionOutcomeScreenState();
}

class _ListTransactionOutcomeScreenState extends State<ListTransactionOutcomeScreen> {
